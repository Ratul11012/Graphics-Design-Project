...
float _angle1 = 0.0f;   // windmill blades
...
glVertex2f(18.5f, -15.5f);
glVertex2f(21.5f, -15.5f);
...
// First Windmill (Left Tower) - Window with Grill (Two Vertical Lines)
glBegin(GL_QUADS);
glColor3ub(139, 69, 19);  // Wooden color for the window
// Defining the window vertices (lowered)
glVertex2f(25.5f, -0.5f);   // bottom-left corner
glVertex2f(26.5f, -0.5f);   // bottom-right corner
glVertex2f(26.5f, 0.5f);    // top-right corner
glVertex2f(25.5f, 0.5f);    // top-left corner
glEnd();

// Grill (Left Windmill Window) - Two Vertical Lines
glLineWidth(2);  // Set line thickness for grill
glColor3ub(0, 0, 0);  // Color of the grill (black)

// First Vertical Grill Line
glBegin(GL_LINES);
glVertex2f(25.75f, -0.5f);  // Bottom of the first vertical line
glVertex2f(25.75f, 0.5f);   // Top of the first vertical line
glEnd();

// Second Vertical Grill Line
glBegin(GL_LINES);
glVertex2f(26.25f, -0.5f);  // Bottom of the second vertical line
glVertex2f(26.25f, 0.5f);   // Top of the second vertical line
glEnd();
...
// Second Windmill (Right Tower) - Window with Grill (Two Vertical Lines)
glBegin(GL_QUADS);
glColor3ub(139, 69, 19);  // Wooden color for the window
// Defining the window vertices (lowered)
glVertex2f(31.5f, -0.5f);   // bottom-left corner
glVertex2f(32.5f, -0.5f);   // bottom-right corner
glVertex2f(32.5f, 0.5f);    // top-right corner
glVertex2f(31.5f, 0.5f);    // top-left corner
glEnd();

// Grill (Right Windmill Window) - Two Vertical Lines
glLineWidth(2);  // Set line thickness for grill
glColor3ub(0, 0, 0);  // Color of the grill (black)

// First Vertical Grill Line
glBegin(GL_LINES);
glVertex2f(31.75f, -0.5f);  // Bottom of the first vertical line
glVertex2f(31.75f, 0.5f);   // Top of the first vertical line
glEnd();

// Second Vertical Grill Line
glBegin(GL_LINES);
glVertex2f(32.25f, -0.5f);  // Bottom of the second vertical line
glVertex2f(32.25f, 0.5f);   // Top of the second vertical line
glEnd();
...
void playSceneSound(const char* filename) {
...
void keyboard(unsigned char key, int, int) {
    switch (key) {
        ...
        case '1':
            stopSound();
             playSceneSound("mixkit-morning-birds-2472.wav");
            showScene5=false;
            showScene3 = false;
            showscene2 = false;
            showscene4 = false;
        ...
        case '2':
            stopSound();
            playSceneSound("insect_chirping.wav");
             showScene5=false;
            showScene3 = false;
            showscene2 = true;
            showscene4 = false;
        ...
        case '3':
            stopSound();
            playSceneSound("mixkit-sea-waves-with-birds-loop-1185.wav");
             showScene5=false;
            showScene3 = true;
            showscene2 = false;
            showscene4 = false;
        ...
        case '4':
            stopSound();
            playSceneSound("mixkit-sea-waves-loop-1196.wav");
             showScene5=false;
            showscene4 = true;
            showScene3 = false;
            showscene2 = false;
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("The way to Saint-Martin Island");
